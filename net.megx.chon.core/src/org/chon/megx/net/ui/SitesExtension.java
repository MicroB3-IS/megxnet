...
public class SitesExtension extends AbstractMegxUIExtension {

	public SitesExtension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new SitesExtTplObj(service, req, resp, node);
	}
