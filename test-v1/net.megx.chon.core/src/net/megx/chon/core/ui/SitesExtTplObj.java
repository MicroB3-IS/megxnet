...
public class SitesExtTplObj {
	...
	public SitesExtTplObj(/*IGenomes*/ MpiWsService service, Request req, Response resp,
			IContentNode node) {
	...
	public String render() {
		...
		int itemsOnPage = 30;
		try {
			List<SamplingSite> s = service.getSites("","",0, itemsOnPage, version);
		...
		return resp.formatTemplate("megx.net/ext/table/sites_table.html", params);
	}
}
