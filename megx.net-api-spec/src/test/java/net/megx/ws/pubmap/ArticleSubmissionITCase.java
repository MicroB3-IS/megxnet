...
public class ArticleSubmissionITCase {
   ...
   * 
   * @param article
   *          the article json provided from bookmarklet.
   */
  @Test
  ...
  public void successfulArticleSubmission() throws IOException {
    ...
    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).formParam("article", article).when()
        .post(this.wsPrefix + "/article").then().statusCode(200).log();
  ...
  public void failArticleSubmission() throws IOException {
    ...
    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).formParam("article", "").when()
        .post(this.wsPrefix + "/article").then().statusCode(400).log();
  }
  ...
  public void successfulRetrieveAllArticles() {
    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).get(this.wsPrefix + "/all").then()
        .statusCode(200).log();
  }
  ...
  /**
   * Test case for: i have the coordinates give me the place name when latitude
  ...
  /**
   * Test case for: i have the coordinates give me the place name when longitude
   * parameter not provided.
   * 
   * @param lat
   *          the latitude value
   ...
   *          the place name
   * @param worldRegion
   *          the region scope for the place name
   */
  @Test
  @Category({ IntegrationTest.class, RESTServiceTest.class })
  ...
  /**
   * Test case for: i have ocean name give me the coordinates when ocean
   * selected and place name not required.
   * 
   * @param q
   *          the place name
   * @param worldRegion
  ...
  /**
   * Test case for: i have location name give me the coordinates when place name
   * not found in region scope.
   * 
   * @param q
   *          the place name
   * @param worldRegion
  ...
  /**
   * Test case for: correct result compared to geonames service result when i
   * have location name give me the coordinates.
   * 
   * @param q
   *          the place name
   * @param worldRegion
  ...
  @Test
  @Category({ IntegrationTest.class, RESTServiceTest.class })
  public void successfulRelevantResultForBremen() {

    HashMap<String, String> parametersMap = new HashMap<String, String>();
    parametersMap.put("q", "bremen");
    parametersMap.put("worldRegion", "DE");

    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).queryParameters(parametersMap)
        .get(this.wsPrefix + "/coordinates").then().statusCode(200)
        .body("data.lat", equalTo("53.07516"))
        .body("data.lon", equalTo("8.80777")).log();
  }
  ...
  @Test
  @Category({ IntegrationTest.class, RESTServiceTest.class })
  public void successfulRelevantResultForMunchen() {

    HashMap<String, String> parametersMap = new HashMap<String, String>();
    parametersMap.put("q", "munchen");
    parametersMap.put("worldRegion", "DE");

    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).queryParameters(parametersMap)
        .get(this.wsPrefix + "/coordinates").then().statusCode(200)
        .body("data.lat", equalTo("48.13743"))
        .body("data.lon", equalTo("11.57549")).log();
  }
  ...
  @Test
  @Category({ IntegrationTest.class, RESTServiceTest.class })
  public void successfulRelevantResultForMunich() {

    HashMap<String, String> parametersMap = new HashMap<String, String>();
    parametersMap.put("q", "munich");
    parametersMap.put("worldRegion", "DE");
  ...
  @Test
  @Category({ IntegrationTest.class, RESTServiceTest.class })
  public void successfulRelevantResultForBerlin() {

    HashMap<String, String> parametersMap = new HashMap<String, String>();
    parametersMap.put("q", "berlin");
    parametersMap.put("worldRegion", "DE");

    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).queryParameters(parametersMap)
        .get(this.wsPrefix + "/coordinates").then().statusCode(200)
        .body("data.lat", equalTo("52.52437"))
        .body("data.lon", equalTo("13.41053")).log();
  }
  ...
  @Test
  @Category({ IntegrationTest.class, RESTServiceTest.class })
  public void successfulRelevantResultForHelgoland() {

    HashMap<String, String> parametersMap = new HashMap<String, String>();
    parametersMap.put("q", "helgoland");
    parametersMap.put("worldRegion", "DE");

    given().filter(ResponseLoggingFilter.logResponseTo(System.out))
        .contentType(ContentType.JSON).queryParameters(parametersMap)
        .get(this.wsPrefix + "/coordinates").then().statusCode(200)
        .body("data.lat", equalTo("54.18213"))
        .body("data.lon", equalTo("7.88458")).log();
  }
