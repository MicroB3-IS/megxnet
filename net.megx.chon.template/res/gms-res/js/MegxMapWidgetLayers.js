MegxMapWidgetLayerSet = function (setName) {
  this.init(setName);
}

MegxMapWidgetLayerSet.prototype = {
  init : function (setName) {
    ...
    case "esa":
      ...
      break;
    default:
      alert("No valid layer set")
    }
  }

  MegxMapWidgetLayers = function (config) {
  ...
  MegxMapWidgetLayers.prototype = {
    ...
    init : function (config) {
      var gms_wms_url = config.gms_wms_url;
      var extent = config.extent;
      var sam_genomes = config.sam_genomes;
      var sam_rrna = config.sam_rrna;
      var sam_phages = config.sam_phages;
      var sam_metagenomes = config.sam_metagenomes;
