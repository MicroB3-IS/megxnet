...
public class SamplesExtension extends AbstractMegxUIExtension {

	public SamplesExtension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new SamplesExtTplObj(service, req, resp, node);
	}
