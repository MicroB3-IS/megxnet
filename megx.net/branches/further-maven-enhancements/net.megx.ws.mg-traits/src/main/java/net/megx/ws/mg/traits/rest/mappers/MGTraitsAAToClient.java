...
public class MGTraitsAAToClient {
	...
	public MGTraitsAAToClient(MGTraitsAA mgTraitsAA) {
		super();
		this.sampleLabel = mgTraitsAA.getSampleLabel();
		this.ala = mgTraitsAA.getAla();
		this.cys = mgTraitsAA.getCys();
		this.asp = mgTraitsAA.getAsp();
		this.glu = mgTraitsAA.getGlu();
		this.phe = mgTraitsAA.getPhe();
		this.gly = mgTraitsAA.getGly();
		this.his = mgTraitsAA.getHis();
		this.ile = mgTraitsAA.getIle();
		this.lys = mgTraitsAA.getLys();
		this.leu = mgTraitsAA.getLeu();
		this.met = mgTraitsAA.getMet();
		this.asn = mgTraitsAA.getAsn();
		this.pro = mgTraitsAA.getPro();
		this.gln = mgTraitsAA.getGln();
		this.arg = mgTraitsAA.getArg();
		this.ser = mgTraitsAA.getSer();
		this.thr = mgTraitsAA.getThr();
		this.val = mgTraitsAA.getVal();
		this.trp = mgTraitsAA.getTrp();
		this.tyr = mgTraitsAA.getTyr();
		this.intId = mgTraitsAA.getId();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MGTraitsAAToClient other = (MGTraitsAAToClient) obj;
		if (ala == null) {
			if (other.ala != null)
				return false;
	...
	public String toString() {
		return "MGTraitsAAToClient [id=" + id + ", sampleLabel=" + sampleLabel
				+ ", ala=" + ala + ", cys=" + cys + ", asp=" + asp + ", glu="
				+ glu + ", phe=" + phe + ", gly=" + gly + ", his=" + his
				+ ", ile=" + ile + ", lys=" + lys + ", leu=" + leu + ", met="
				+ met + ", asn=" + asn + ", pro=" + pro + ", gln=" + gln
				+ ", arg=" + arg + ", ser=" + ser + ", thr=" + thr + ", val="
				+ val + ", trp=" + trp + ", tyr=" + tyr + "]";
	}
