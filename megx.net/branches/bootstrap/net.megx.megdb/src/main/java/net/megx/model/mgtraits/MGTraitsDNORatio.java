...
public class MGTraitsDNORatio {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MGTraitsDNORatio other = (MGTraitsDNORatio) obj;
		if (id != other.id)
			return false;
		if (paa_ptt == null) {
	...
	public String toString() {
		return "MGTraitsDNORatio [sampleLabel=" + sampleLabel + ", paa_ptt="
				+ paa_ptt + ", pac_pgt=" + pac_pgt + ", pcc_pgg=" + pcc_pgg
				+ ", pca_ptg=" + pca_ptg + ", pga_ptc=" + pga_ptc
				+ ", pag_pct=" + pag_pct + ", pat=" + pat + ", pcg=" + pcg
				+ ", pgc=" + pgc + ", pta=" + pta + ", id=" + id + "]";
	}
