...
public class GenomesExtension extends AbstractMegxUIExtension {

	public GenomesExtension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new GenomesExtTplObj(service, req, resp, node);
	}
