...
public class PublicJobDetailsToClient {
	...
	public PublicJobDetailsToClient(MGTraitsPublicJobDetails publicJobDetails) {
		super();
		this.id = publicJobDetails.getId();
		this.customer = publicJobDetails.getCustomer();
		this.sampleLabel = publicJobDetails.getSampleLabel();
		this.sampleEnvironment = publicJobDetails.getSampleEnvironment();
		this.mgUrl = publicJobDetails.getMgUrl();
		this.timeSubmitted = publicJobDetails.getTimeSubmitted();
		this.gcContent = publicJobDetails.getGcContent();
		this.gcVariance = publicJobDetails.getGcVariance();
		this.numGenes = publicJobDetails.getNumGenes();
		this.totalMB = publicJobDetails.getTotalMB();
		this.numReads = publicJobDetails.getNumReads();
		this.ABRatio = publicJobDetails.getABRatio();
		this.percTf = publicJobDetails.getPercTf();
		this.percClassified = publicJobDetails.getPercClassified();
	}
	...
	public String toString() {
		return "PublicJobDetailsToClient [id=" + id + ", customer=" + customer
