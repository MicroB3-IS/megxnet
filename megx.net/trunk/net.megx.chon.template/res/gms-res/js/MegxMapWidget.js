...
MegxMapWidget = function (elem, layerSet, config) {
  //TODO: check minimum config params
  //TODO: check URL
  if (elem || elem === '') {
    //TODO throw exception or do alert?
  }
  if (layerSet || layerSet === '') {
    //TODO throw exception or do alert?
  }
  this.init(elem, layerSet, config);
}
...
MegxMapWidget.prototype = {
  ...
  init : function (elem, layerSet, config) {
    ...
    //console.log("Initialize map on gmsURL = " + config.gmsURL);
