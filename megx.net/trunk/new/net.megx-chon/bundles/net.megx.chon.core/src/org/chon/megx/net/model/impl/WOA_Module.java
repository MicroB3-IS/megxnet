 ...
 */
package org.chon.megx.net.model.impl;
...
import org.chon.megx.net.services.WoaService;
import org.chon.web.api.Request;
import org.chon.web.api.Response;
import org.chon.web.api.ServerInfo;

public class WOA_Module extends ModuleContentNode {
	private static final Log log = LogFactory.getLog(WOA_Module.class);
	
	public WOA_Module(ContentModel model, Node node, IContentNode typeDesc) {
	...
	public void process(Request req, Response resp, ServerInfo serverInfo) throws Exception {
		...
		String depth = getParam(req, "depth", null);
		String season = getParam(req, "season", null);
		String parameter = getParam(req, "grid", "parameter");
