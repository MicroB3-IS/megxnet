...
public class UserServiceTest extends DBServiceTest{
	...
	public static String USERNAME = "newTest";
...
//		userService.addUser(defaultUser);
	...
	@Test
	@ExpectedDataSet("UserServiceTest.testAddUser-result.xml")
	...
	@Test
	@DataSet("UserServiceTest.testRemoveUser.xml")
