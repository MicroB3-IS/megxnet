...
public class TagCloudExtenstion extends AbstractMegxUIExtension  {


	public TagCloudExtenstion(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new TagCloudTplObj(service, req, resp, node);
	}
}
