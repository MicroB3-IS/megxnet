...
public class MetagenomesExtension extends AbstractMegxUIExtension {

	public MetagenomesExtension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new MetagenomesExtTplObj(service, req, resp, node);
	}
