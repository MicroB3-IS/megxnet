...
public class CSVDocumentBuilder {
     ...
     *            not annotated)
     * @param data
     *            {@link List} of beans holding the actual data
     * @return {@link CSVDocumentInfo} representing the real CSV document and
     *         additional info needed for serialization
     * @throws IntrospectionException
     */
    public CSVDocumentInfo createDocument(boolean writeHeaderColumns,
        ...
        return createDocument(writeHeaderColumns, separator, quoteChar,
                lineEnd, beanType, columns, data, ColumnNameFormat.NONE);
    }
     ...
     *            not annotated)
     * @param data
     *            any type of bean representing the data for this CSV document
     * @param format
     *            Column name format. See {@link ColumnNameFormat} for more
     *            details.
     * @return {@link CSVDocumentInfo} representing the real CSV document and
     *         additional info needed for serialization
     * @throws IntrospectionException
    ...
    public CSVDocumentInfo createDocument(boolean writeHeaderColumns,
            char separator, char quoteChar, String lineEnd, Class<?> beanType,
            String[] columns, Object data, ColumnNameFormat format)
            throws IntrospectionException {
        List<Object> ld = null;
    ...
    public CSVDocumentInfo createDocument(boolean writeHeaderColumns,
            char separator, char quoteChar, String lineEnd, Class<?> beanType,
            String[] columns, List<?> data, ColumnNameFormat format)
            throws IntrospectionException {
