...
public class MixsWsServiceImpl implements MixsWsService {
	...
	public List<ChecklistItemDetails> getCombinedChecklistSpecificationItems(
		...
		return mixsWsDao.getCombinedChecklistSpecificationItems(clName,
				envPackage, version);
	}
	...
	public List<IndependentMetadataItem> getIndependentMetadataItems(
			Map<Object, Object> map, String version) throws Exception {
	...
	public ChecklistItemDetails getParticularSpecificationItem(String itemName,
			String clNameEnvPkg, String version) throws Exception {
		return mixsWsDao.getParticularSpecificationItem(itemName, clNameEnvPkg,
				version);
	}
	
	public List<EnvPackage> getEnvPackagesList(String version) throws Exception{
		return mixsWsDao.getEnvPackagesList(version);
	}

	public List<ExistingChecklists> getExistingChecklists(String version)
			throws Exception {
		return mixsWsDao.getExistingChecklists(version);
	}
