...
public class PhagesExtension extends AbstractMegxUIExtension {

	public PhagesExtension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new PhagesExtTplObj(service, req, resp, node);
	}
