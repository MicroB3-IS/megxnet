...
public class RRNAExtension extends AbstractMegxUIExtension {

	public RRNAExtension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new RRNAExtTplObj(service, req, resp, node);
	}
