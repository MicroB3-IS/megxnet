...
public class WOA5Extension extends AbstractMegxUIExtension {

	public WOA5Extension(BundleContext bundleContext) {
		super(bundleContext);
	}
	...
	public Object getTplObject(Request req, Response resp, IContentNode node) {
		...
		return new WOA5ExtTplObj(service, req, resp, node);
	}
